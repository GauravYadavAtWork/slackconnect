...
export const sendInstantMessage = async (req: SlackRequest, res: Response) => {
...
export const scheduleMessage = async (req: SlackRequest, res: Response) => {
  ...
  try {
    ...
    const newScheduledMessage = new ScheduledMessage({
      ...
      channel,
      text,
      schedule_time: scheduleTimeInUTC,
    });
...
export const getScheduledMessages = async (req: SlackRequest, res: Response) => {
  const authed_user = req.query.authed_user as string;
...
export const deleteScheduledMessage = async (req: SlackRequest, res: Response) => {
